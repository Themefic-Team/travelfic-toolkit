...
function travelfic_toolkit_customizer_style()
{
    ...
    $travelfic_link_color = get_theme_mod($travelfic_kit_pre . 'link_color', '#fa6400');
    ...
    $travelfic_menu_color_hover = get_theme_mod($travelfic_kit_pre . 'menu_hover_color', '#fa6400');
    ...
    $travelfic_submenu_hover = get_theme_mod($travelfic_kit_pre . 'submenu_text_hover_color', '#fa6400');
...
?>
    ...
    <style>
        /* Global colors */
        :root {
            --primary-color: <?php echo esc_attr($travelfic_primary_color) ?>;
            --secondary-color: <?php echo esc_attr($travelfic_secondary_color) ?>;
            --text-color: <?php echo esc_attr($travelfic_text_color) ?>;
            --heading-color: <?php echo esc_attr($travelfic_heading_color) ?>;
            --link-color: <?php echo esc_attr($travelfic_link_color) ?>;
        ...
        .tft-design-3__bottom__nav--list .menu-item a:hover {
            color: <?php echo !empty($travelfic_menu_color_hover) ? esc_attr($travelfic_menu_color_hover . ' !important') : esc_attr('#fa6400 !important'); ?>;
        }
        ...
        .tft-design-2 .tft-menus-section .tft-site-navigation ul.sub-menu>li:hover>a {
            color: <?php echo !empty($travelfic_submenu_hover) ? esc_attr($travelfic_submenu_hover . ' !important') : esc_attr('#fa6400 !important'); ?>;
        }
