    ...
    protected function register_controls() {
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'condition' => [
                    'aprt_location_style' => 'design-2', // Show this control only when blog_style is 'design-1'
                ],
            ]
        );
        // $this->add_control(
        ...
        $this->add_control(
            ...
            [
                ...
                'default'   => '#917242',
                'selectors' => [
                    '{{WRAPPER}} .tft-destination-design-2 .tft-single-destination .tft-destination-content span:hover' => 'background: {{VALUE}} !important',
                ],
                'condition' => [
                    'aprt_location_style' => 'design-2', // Show this control only when aprt_location_style is 'design-2'
                ],
        ...
        $this->add_group_control(
            \Elementor\Group_Control_Typography::get_type(),
            [
                'name'     => 'apartments_locations_sub_list',
        ...
        $this->add_control(
            'apartments_locations_sub_list_color',
            [
                'label'     => __( 'Color', 'travelfic-toolkit' ),
                'type'      => \Elementor\Controls_Manager::COLOR,
                'default'   => '#1D2A3B',
        ...
        $this->add_control(
            'apartments_locations_sub_list_color_hover',
            [
                'label'     => __( 'Hover', 'travelfic-toolkit' ),
                'type'      => \Elementor\Controls_Manager::COLOR,
                'default'   => '#F15D30',
