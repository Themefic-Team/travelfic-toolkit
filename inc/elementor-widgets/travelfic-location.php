...
class Travelfic_Toolkit_HotelLocation extends \Elementor\Widget_Base{
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .tft-location-design-2 .tft-single-destination .tft-destination-thumbnail::before {' => 'background-color: {{VALUE}}',
                ],
                'condition' => [
                    'hotel_location_style' => 'design-2', // Show this control only when hotel_location_style is 'design-2'
                ],
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .tft-location-design-2 .tft-single-destination .tft-destination-content h3',
        ...
        $this->add_control(
            ...
            [
                ...
                'default'   => '#FDF9F3',
                'selectors' => [
                    '{{WRAPPER}} .tft-location-design-2 .tft-single-destination .tft-destination-content h3' => 'color: {{VALUE}}',
                ],
                'condition' => [
                    'hotel_location_style' => 'design-2', // Show this control only when hotel_location_style is 'design-2'
                ],
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .tft-location-design-2 .tft-single-destination .tft-destination-content span',
        ...
        $this->add_control(
            ...
            [
                ...
                'default'   => '#FDF9F3',
                'selectors' => [
                    '{{WRAPPER}} .tft-location-design-2 .tft-single-destination .tft-destination-content span' => 'color: {{VALUE}}',
                ],
                'condition' => [
                    'hotel_location_style' => 'design-2', // Show this control only when hotel_location_style is 'design-2'
                ],
        ...
        $this->add_control(
            ...
            [
                ...
                'default'   => '#B58E53',
                'selectors' => [
                    '{{WRAPPER}} .tft-location-design-2 .tft-single-destination .tft-destination-content span' => 'background: {{VALUE}}',
                ],
                'condition' => [
                    'hotel_location_style' => 'design-2', // Show this control only when hotel_location_style is 'design-2'
                ],
            ...
            foreach ( $all_categories as $cat ) {
                ...
                <div class="tft-single-destination tft-col">
                    <div class="tft-destination-thumbnail tft-thumbnail">
                        <a href="<?php echo esc_url(get_term_link( $cat->slug, 'hotel_location' )); ?>"><img src="<?php echo esc_url($cat_image); ?>" alt="<?php _e("Hotel Location Image", "travelfic-toolkit"); ?>"></a>
                    </div>
    ...
    <div class="tft-destination-design-2 tft-location-design-2" style="background-image: url(<?php echo esc_url( TRAVELFIC_TOOLKIT_URL.'assets/app/img/destination-bg.png' ); ?>);">
