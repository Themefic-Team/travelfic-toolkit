	...
	protected function register_controls()
	{
		...
		$this->add_group_control(
            ...
            [
                ...
                'selector' => ' {{WRAPPER}} .tf-archive-template__one .tf-car-lists-widgets .tf-heading h2',
            ]
        );
		$this->add_control(
            ...
            [
                ...
                'selectors' => [
                    ' {{WRAPPER}} .tf-archive-template__one .tf-car-lists-widgets .tf-heading h2' => 'color: {{VALUE}}',
                ],
            ]
        );
		...
		$this->add_group_control(
            ...
            [
                ...
                'label'    => __( 'Typography', 'travelfic-toolkit' ),
                'selector' => ' {{WRAPPER}} .tf-archive-template__one .tf-car-lists-widgets .tf-heading p',
            ]
        );
		$this->add_control(
            ...
            [
                ...
                'type'      => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
                    ' {{WRAPPER}} .tf-archive-template__one .tf-car-lists-widgets .tf-heading p' => 'color: {{VALUE}}',
                ],
            ]
        );
	}
