<?php
class TravelFicSlider2 extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'TFT Hero Slider 2', 'travelfic' );
	}
	...
	protected function register_controls() {
		...
		// Social icons repeater start
		$repeater = new \Elementor\Repeater();
		$repeater->add_control(
            'social_icon', [
                'label' => __( 'Social Icon', 'travelfic' ),
		...
		$repeater->add_control(
            'social_url', [
                'label' => __( 'Social URL', 'travelfic' ),
                'type' => \Elementor\Controls_Manager::URL,
				'label_block' => true,
            ]
        );
		$this->add_control(
			'hero_social_icon_list',
			[
				'label' => esc_html__( 'Social Icon List', 'travelfic' ),
				'type' => \Elementor\Controls_Manager::REPEATER,
				'fields' => $repeater->get_controls(),
	...
	protected function render() {
		...
		if ( $settings['hero_slider_list'] ) { ?>
            ...
            <div class="hero--slider-wrapper hero--slider-wrapper-2 tft-customizer-typography">
				<div class="hero--tft-social-icons">
					<?php foreach( $settings['hero_social_icon_list'] as $social_item ) : ?>
						<div class="hero--tft-social-icons-items">
							<a href="<?php echo $social_item['social_url']['url'] ?>">
								<?php echo $social_item['social_url']['value'] ?>
							</a>
						</div>
					<?php endforeach; ?>
				</div>
        ...
        // Home Slider
            ...
            "use strict";
				...
				// Blury header				
				$( ".tft-site-header" ).addClass( 'tft-blury-header');
