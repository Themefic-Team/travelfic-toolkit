        ...
        */
                        ...
                        <div class="demo-importing-data-list">
                            <label class="form-control">
                                ...
                                <div class="label-tooltip">
                                    <?php $this->tft_label_tooltip_icon(); ?>
            ...
            <div class="travelfic-template-list-wrapper" id="travelfic-template-list-wrapper" style="background: url(<?php echo esc_url(TRAVELFIC_TOOLKIT_URL . 'assets/admin/img/template_list_bg.png'); ?>), #F8FAFC 50% / cover no-repeat;">
                <div class="travelfic-template-list-container">
                    <div class="travelfic-template-list-heading">
                        ...
                        <span class="bricks-template-import-btn" style="display: none;"><?php esc_html_e("Bricks Template Import", "travelfic-toolkit"); ?></span>
                        ...
                        <div class="travelfic-builder-tabs-wrapper" style="display: flex; flex-direction: column; align-items: center; gap: 12px; margin-bottom: 20px;">
                            <div class="travelfic-builder-tabs">
                                ...
                                <button class="travelfic-builder-tab" data-builder="bricks" <?php echo ! $bricks_active ? 'disabled' : ''; ?>>
                                    ...
                                    <span><?php esc_html_e("Bricks Builder", "travelfic-toolkit"); ?></span>
                                </button>
                            </div>

                            <?php if ( ! $bricks_active ) : ?>
                                <div class="travelfic-builder-notice" style="font-family: 'Inter', sans-serif; font-size: 13px; color: #5C6E80; background: #FFF5F5; border: 1px solid #FFD8D8; padding: 10px 20px; border-radius: 8px; display: inline-flex; align-items: center; gap: 8px; box-shadow: 0px 4px 12px rgba(216, 0, 76, 0.04);">
                                    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#D8004C" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" xmlns="http://www.w3.org/2000/svg" style="flex-shrink: 0;">
                                        <circle cx="12" cy="12" r="10"></circle>
                                        <line x1="12" y1="8" x2="12" y2="12"></line>
                                        <line x1="12" y1="16" x2="12.01" y2="16"></line>
                                    </svg>
                                    <?php if ( $bricks_installed && current_user_can( 'switch_themes' ) ) : ?>
                                        <?php 
                                        ...
                                        ?>
                                        <span>
                                            <?php esc_html_e( 'Bricks theme is inactive.', 'travelfic-toolkit' ); ?>
                                            <a href="<?php echo esc_url( $activate_url ); ?>" style="color: #D8004C; font-weight: 700; text-decoration: underline; margin-left: 4px;">
		...
		public function travelfic_toolkit_activation_redirect() {
			...
			if ( ! get_option( 'travelfic_toolkit_template_wizard' ) ) {
                ...
                if ( $current_active_theme != 'travelfic' && $current_active_theme != 'travelfic-child' && $current_active_theme != 'ultimate-hotel-booking' && $current_active_theme != 'ultimate-hotel-booking-child' && $current_active_theme != 'bricks' && $current_active_theme != 'bricks-child' ) {
                    wp_safe_redirect( admin_url( 'themes.php' ) );
                }else{
				    wp_safe_redirect( admin_url( 'admin.php?page=travelfic-template-list' ) );
                }
				exit;
			}
		}
