(function ($) {
  wp.customize("travelfic_customizer_settings_stiky_header", function (value) {
    ...
    function toggleFields(value) {
      if ("enabled" === value) {
        $(
          'li[id*="travelfic_customizer_settings_stiky_header_bg_color"],li[id*="travelfic_customizer_settings_stiky_header_blur"],li[id*="travelfic_customizer_settings_stiky_header_menu_text_color"]'
        ).show();
      } else {
        $(
          'li[id*="travelfic_customizer_settings_stiky_header_bg_color"],li[id*="travelfic_customizer_settings_stiky_header_blur"],li[id*="travelfic_customizer_settings_stiky_header_menu_text_color"]'
  ...
  wp.customize(
    "travelfic_customizer_settings_header_tab_select",
    function (value) {
  ...
  wp.customize(
    "travelfic_customizer_settings_footer_tab_select",
    function (value) {
      function tab_toggleFields(value) {
        if ("design" === value) {
          $(
            'li[id*="customize-control-travelfic_customizer_settings_footer_bg_color"], li[id*="customize-control-travelfic_customizer_settings_footer_text_color"] '
          ).show();

          $(
            'li[id*="customize-control-travelfic_customizer_settings_footer_width"], li[id*="customize-control-travelfic_customizer_settings_footer_design_select"] '
          ).hide();
        } else {
          $(
            'li[id*="customize-control-travelfic_customizer_settings_footer_width"], li[id*="customize-control-travelfic_customizer_settings_footer_design_select"] '
  ...
  wp.customize.controlConstructor["image_select"] = wp.customize.Control.extend(
    {
      ready: function () {
        var control = this;
        var value =
          undefined !== control.setting._value ? control.setting._value : "";
